...
export const HOLE_DESCRIPTIONS = [
  { id: HOLES.X11Only, description: "Your app enables x11. x11 does not support isolation between apps. E.g. keylogging, screen capture." },

  { id: HOLES.X11AndWayland, description: "Your app enables both x11 and wayland. x11 does not support isolation between apps. E.g. keylogging, screen capture." },
