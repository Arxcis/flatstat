export const ACHIEVEMENTS = {
  ...
  NoNameTalk: "--no-name-talk",
  NoNameOwn: "--no-name-own"
};
...
export const ACHIEVEMENT_DESCRIPTIONS = [
  ...
  { id: ACHIEVEMENTS.NoFilesystemAll, description: "Your app does not ask for blanket access to the entire filesystem, like --filesystem=home or --filesystem=host." },
  ...
  { id: ACHIEVEMENTS.NoNameTalk, description: "Your app does not talk to any names on the system- or session-bus. Your app is likely using portals instead." },

  { id: ACHIEVEMENTS.NoNameOwn, description: "Your app does not own any names on the system- or session-bus. Your app is likely using portals instead." },
]
