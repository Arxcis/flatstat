...
export const ACHIEVEMENT_DESCRIPTIONS = [
  ...
  { id: ACHIEVEMENTS.OnlyPipewire, description: "Your app supports only Pipewire. Pipewire supports isolation between apps. Pipewire is enabled with \"--filesystem=xdg-run/pipewire-0\""}
]
