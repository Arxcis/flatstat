...
export const ACHIEVEMENT_DESCRIPTIONS = [
  ...
  { id: ACHIEVEMENTS.NoOwnName, description: "Your app does not own any names on the system- or session-bus - not using any --own-name=NAME or --system-own-name=NAME. Your app is likely using portals instead." },
