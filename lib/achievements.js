...
export const ACHIEVEMENT_DESCRIPTIONS = [
  ...
  { id: ACHIEVEMENTS.Pipewire, description: "Your app supports Pipewire. Pipewire supports isolation between apps. Your app is enabling pipewire by using the \"--filesystem=xdg-run/pipewire-0\"-flag"}
]
