...
export function incrementAchievementCount(finishArgs, count = {}) {
  ...
  return {
    ...
    ...increment(ACHIEVEMENTS.OnlyPipewire, hasOnlyPipewire(socket, filesystem)),
...
const hasOnlyPipewire = (socket, filesystem) => !socket.includes("pulseaudio") && filesystem.includes("xdg-run/pipewire-0");
